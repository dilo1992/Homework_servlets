                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Областью использования бетонных смесей являются строительные сооружения,
                            ...
                            Данный параметр
                            залагается в наименовании марки бетона.</p>
                    </div>
                    <div class="price">
                        <p class="card-price" style="text-align: center"> Цена за 1 кубический метр:
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Данная марка бетона принадлежит к стройматериалам, входящим в состав
                            ...
                            компонента на
                            1м3, чем для материалов, относящихся к простым классам, именно это является причиной того,
                            что
                            технические характеристики М350 многообразнее.</p>
                    </div>
                    <div class="price">
                        <p class="card-price" style="text-align: center"> Цена за 1 кубический метр:
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Бетон М500 – популярный и надежный материал. Он не боится агрессивной среды
                            ...
                            способен выдерживать максимальные нагрузки. Чаще всего бетон М500 используется для:
